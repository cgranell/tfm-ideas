...
*Summary*: The objective of this TFM is to explore and uncover the cycling movement in Castellón, based on the data provided by the local biking-shared system. Instead of focusing on the collection, preparation and fusion of data (see [Fabian's thesis]()), the goal instead is to design and develop a visual and interactive (geo)narrative to communicate to a broad audience how cyclists move in Castellón. The main source of information is the bicycle trips data set already processed and generated by [Fabian's thesis](), which will be accessible soon in [Zenodo](). The expected results are a series of interactive maps and visualisations (e.g. storyMas) to communicate to and convince key stakeholders and society alike remarkable patterns of mobility of the residents of Castellón, to reveal the *true mobility character* of the city of Castellón. Such (geo-)narratives can contain maps on the density of daily trips, recreational trips vs commuting trips, etc. 
...
*Methods*: Story telling, use cases, geo-narratives, visual narratives, science communication, reproducibility practices 
